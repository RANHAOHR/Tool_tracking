...
if(NOT "/home/ranhao/ros_ws/Tool_tracking/tool_tracking/include " STREQUAL " ")
  set(tool_tracking_INCLUDE_DIRS "")
  set(_include_dirs "/home/ranhao/ros_ws/Tool_tracking/tool_tracking/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tool_tracking' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ranhao/ros_ws/Tool_tracking/tool_tracking/${idir}'.  Ask the maintainer 'rxh349 <rxh349@case.edu>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ranhao/ros_ws/Tool_tracking/tool_tracking/cmake-build-debug/devel/lib;/home/ranhao/ros_ws/devel/lib;/opt/ros/indigo/lib)
