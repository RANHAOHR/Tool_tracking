...
if(NOT "/home/ranhao/ros_ws/src/Tool_tracking/tool_tracking/include " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'rxh349 <rxh349@case.edu>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'tool_tracking' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'tool_tracking' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ranhao/ros_ws/src/Tool_tracking/tool_tracking/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ranhao/ros_ws/src/Tool_tracking/tool_tracking/cmake-build-debug/devel/lib;/home/ranhao/ros_ws/devel/lib;/opt/ros/kinetic/lib)
...
set(depends "cv_bridge;image_transport;roscpp;sensor_msgs;std_msgs;message_runtime;cwru_opencv_common;tool_model;geometry_msgs;cwru_davinci_interface;cwru_davinci_kinematics;xform_utils")
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${tool_tracking_dep}_FOUND)
      find_package(${tool_tracking_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${tool_tracking_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
