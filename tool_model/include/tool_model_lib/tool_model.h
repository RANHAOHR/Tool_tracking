...
public:
    ...
    /// compute the pose for the tool model based on the ELLIPSE pose, return the pose within inputModel
    void computeModelPose(toolModel &inputmodel, const double &theta_tool, const double &theta_grip_1,
